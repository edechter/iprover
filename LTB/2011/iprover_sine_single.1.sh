...
if [ "$CAT" == "LTB.SMO" ]; then
    echo "$CAT Slices"
    SLICE[0]="-ss included -sd 0 -st 2"
    SLICE[1]="-ss included -sd 2 -st 1"
    SLICE[2]="-ss included -sd 4 -st 1.3 "
    SLICE[3]="-ss included -sd 6 -st 1.5"
    SLICE[4]="-ss included -sd 8 -st 2"
    SLICE[5]="-ss included -sd 10 -st 5"
    SLICE[6]="-ss included -sd 0 -st 1.2"
    SLICE[7]="-ss included -sd 0 -st 1.3"   
    SLICE[8]=" "
    
    SLICE[9]="-ss axioms"
    SLICE[10]="-ss included -sd 0  -st 10"
